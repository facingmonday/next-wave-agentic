...
import { VerticalMissionSlide } from "@/components/VerticalMissionSlide";
          ...
          <div className="max-w-5xl mx-auto px-6 space-y-10">
            ...
            >
              <p className="text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto text-center">
                We are an ecosystem of creators, engineers, and
                experience-makers who turn ideas into reality. From software to
                real-world events to AI-driven storytelling, we build the
                systems, stories, and experiences that bring visions to life.
              </p>
            </ContentReveal>
