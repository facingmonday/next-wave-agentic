            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
              <div>
                ...
                <p className="text-lg text-gray-300 leading-relaxed mb-4">
                  ...
                  prioritizes discovery over search, community over transaction,
                  and connection over convenience. This approach has enabled
                  Kikits to facilitate hundreds of events, building a vibrant
          ...
          <ContentReveal direction="up" duration={1.2} startOffset="top 80%">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto mb-8">
                ...
                experience for both event creators and attendees, with real-time
                updates and intuitive event management tools.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-lg text-gray-300 leading-relaxed mb-4">
                  ...
                  keep users informed about event updates, ticket availability,
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  Looking forward, we continue to enhance the platform with new
                  features, improved user experiences, and expanded capabilities
                  that make event discovery and management even more seamless
                  and engaging.
                </p>
              </div>
            </div>
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="bg-[#3F395B]/50 p-6 rounded-xl border border-[#4E79A7]/30">
                ...
                <p className="text-gray-300">
                  ...
                  interactions, making event discovery feel natural and engaging
              ...
              <div className="bg-[#3F395B]/50 p-6 rounded-xl border border-[#4E79A7]/30">
                ...
                <p className="text-gray-300">
                  ...
                  activity keep users informed and engaged throughout the event
                  lifecycle.
                </p>
              </div>
            </div>
          ...
          <ContentReveal direction="up" duration={1.2} startOffset="top 80%">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto mb-8">
                ...
                platform to life, explaining features, showcasing capabilities,
                and connecting with audiences through authentic storytelling.
                Each video demonstrates how Kikits makes event discovery and
                management seamless.
              </p>
            </div>
            <div className="py-8">
          ...
          <ContentReveal direction="up" duration={1.2} startOffset="top 80%">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300 leading-relaxed max-w-3xl mx-auto mb-8">
                ...
                tool we use to create and manage our own event experiences. The
                platform enables seamless ticket sales, attendee management, and
                event promotion, facilitating hundreds of events and building a
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
              <div>
                ...
                <p className="text-lg text-gray-300 leading-relaxed">
                  ...
                  effectively market their events, creating engaging videos and
                  narratives that connect with audiences and drive attendance.
                </p>
              </div>
              <div className="bg-[#3F395B]/50 p-8 rounded-xl border border-[#4E79A7]/30">
                <h3 className="text-xl font-semibold text-[#CFC8CF] mb-4">
                ...
                <ul className="space-y-3 text-gray-300">
                  ...
                  <li className="flex items-start">
                    <span className="text-[#4E79A7] mr-2">•</span>
                    <span>
                      AI-powered marketing content that connects with audiences
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#4E79A7] mr-2">•</span>
                    <span>
                      Community features that foster connection among attendees
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#4E79A7] mr-2">•</span>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="bg-[#3F395B]/50 p-6 rounded-xl border border-[#4E79A7]/30">
                ...
                <p className="text-gray-300">
                  ...
                  concerts to large-scale festivals, building a track record of
                  successful event management and community building.
                </p>
              </div>
              <div className="bg-[#3F395B]/50 p-6 rounded-xl border border-[#4E79A7]/30">
                <h3 className="text-xl font-semibold text-[#CFC8CF] mb-4">
                ...
                <p className="text-gray-300">
                  ...
                  attendees discover events and connect with like-minded people
              ...
              <div className="bg-[#3F395B]/50 p-6 rounded-xl border border-[#4E79A7]/30">
                ...
                <p className="text-gray-300">
                  Event creators benefit from comprehensive management tools and
                  AI-powered marketing content that helps them effectively
          ...
          <ContentReveal direction="up" duration={1.2} startOffset="top 80%">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto">
                ...
                content creation, and community building. Here&apos;s what went
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-[#3F395B]/50 p-8 rounded-xl border border-[#4E79A7]/30">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  fast, responsive interfaces while maintaining code quality and
                  maintainability.
                </p>
              </div>
              <div className="bg-[#3F395B]/50 p-8 rounded-xl border border-[#4E79A7]/30">
              ...
              <div className="bg-[#3F395B]/50 p-8 rounded-xl border border-[#4E79A7]/30">
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  The platform&apos;s design prioritizes discovery and community
                  over transaction, creating an experience that feels natural
                  and engaging. Every interaction was carefully crafted to
                  foster connection and make event discovery feel like
