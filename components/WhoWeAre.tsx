        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          <div className="grid grid-cols-2 gap-6 md:gap-8">
            {teamMembers.map((member) => (
              <div
                key={member.id}
                className="bg-gradient-to-br from-[#201E30] to-[#3F395B] rounded-xl overflow-hidden border-2 border-[#3F395B] hover:border-[#4E79A7] transition-all group"
              >
                {/* Member Photo */}
                ...
                <div className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-[#CFC8CF] mb-1 uppercase">
                    {member.name}
                  </h3>
                    ...
                    <div className="flex gap-2">
                      {member.socialLinks.instagram && (
                        <a
                          ...
                          className="w-8 h-8 rounded-full bg-[#4E79A7] flex items-center justify-center hover:bg-[#4E79A7]/80 transition-colors"
                          aria-label={`${member.name} Instagram`}
                        >
                          <svg
                            className="w-4 h-4 text-[#CFC8CF]"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                          >
