...
<div class="my-8 flex justify-center">
  <a href="/skills/aeo-optimization.md" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full bg-[#4E79A7] px-8 py-4 font-semibold transition-colors hover:bg-[#4E79A7]/90 no-underline">
    <span class="">Open AEO Optimization Skill (Markdown)</span>
  </a>
</div>
